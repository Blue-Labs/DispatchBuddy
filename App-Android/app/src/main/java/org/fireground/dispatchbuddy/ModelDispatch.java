...
public class ModelDispatch {
     ...
     */
    public ModelDispatch(String isotimestamp, String date_time,
                         String event_uuid, String event_status,
                         String city, String owning_city, String owning_station,
    ...
    public Integer getAdapterPosition() { return adapterPosition; }
    public Map<String, RespondingPersonnel> getRespondingPersonnel() { return respondingPersonnel; }
    ...
    public Map<String, Object> toMap() {
        Log.i("ModelDispatch", "Map called");
