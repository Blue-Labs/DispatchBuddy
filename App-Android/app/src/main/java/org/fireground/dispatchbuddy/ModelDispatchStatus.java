...
public class ModelDispatchStatus {
    public String key;
    ...
    public ModelDispatchStatus() {}

    public ModelDispatchStatus(String key, Boolean en_route, Boolean on_scene, Boolean clear_scene, Boolean in_quarters
                                , Map<String, RespondingPersonnel> responding_personnel
                                , Map<String, RespondingUnits> responding_units
                              ) {
        this.key = key;
